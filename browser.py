...
class CefWidget(QtGui.QX11EmbedContainer):
    ...
    def embedBrowser(self):
        ...
        self.browser = cef.CreateBrowserSync(window_info, url="http://www.google.com/")
...
class Browser(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self._highlighter = WebElementHighlighter(self._ui.centralwidget)

        self._cef_widget = CefWidget(self)
        self._ui.main_frame.addWidget(self._cef_widget)

        self._cef_widget.embedBrowser()
   ...
   #        return QtGui.QMainWindow.eventFilter(self, obj, event)
    ...
    def browse(self):
       ...
       #self._cef_widget.browser.LoadUrl(QtCore.QUrl(url))
